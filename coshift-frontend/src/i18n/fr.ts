...
export const fr = {
  ...
  admin: {
    ...
    colonneRole: "Rôle",
    roleUSER: "Membre",
    roleADMIN: "Admin. d'organisation",
    roleSUPER_ADMIN: "Admin. de plateforme",
    changerRole: "Changer le rôle de {nom}",
    changerRoleAide:
      "Distribuer un rôle est le pouvoir qui contient tous les autres. L'opération est consignée au journal de sécurité avec l'ancien rôle, le nouveau, et qui a décidé.",
    confirmerRole: "Attribuer ce rôle",
    colonneEtat: "État",
